 ...
 * Categorie
 *
 * @ORM\Table(name="Categoriesermon")
 * @ORM\Entity(repositoryClass="Meupf\PlateformBundle\Repository\CategorieSermonRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class CategorieSermon
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Sermon", mappedBy="categorie", cascade={"remove", "merge"})
     */
    private $sermons;
    ...
    public function removeSermon(Sermon $sermon)
    {
